...
- [ ] Define Prisma schema matching above design
- [ ] Create initial migration
- [ ] Build database connection layer with runtime config injection
- [ ] Create basic CRUD API routes for markers

#### Phase 2: Manual Import & Export (v3.0-beta.1)
- [ ] Build "Import from Stashapp" button for scene markers
- [ ] Import creates/updates local markers based on stashapp_marker_id
- [ ] Build "Export to Stashapp" button for selected markers (basic tags only)
- [ ] Track export status (exported_to_stashapp, last_exported_at)
...
- [ ] Store PySceneDetect results exclusively in local DB (marker_type='shot_boundary')
- [ ] Update PySceneDetect script to write to local DB via API
- [ ] Build UI for viewing shot boundaries without exporting to Stashapp
- [ ] Add optional export for selected shot boundaries

#### Phase 4: Marker Slots System (v3.0-beta.3)
- [ ] Implement slot_definitions CRUD
- [ ] Build slot UI components (slot editor, performer picker)
- [ ] Create slot_definitions seed data for common scenarios
- [ ] Add slot display to marker detail view
- [ ] Implement slot-based filtering

#### Phase 5: AI Workflows Foundation (v3.0-beta.4)
...
#### Phase 6: YOLO Integration (v3.0-rc.1)
...
#### Phase 7: Performance & Search (v3.0-rc.2)
