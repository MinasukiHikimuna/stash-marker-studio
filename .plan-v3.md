...
- [ ] Optional cleanup: Remove temporary slot editing from TempMarkerForm
- [ ] Optional enhancement: Limit performers only to the ones assigned to the scene in Stashapp
